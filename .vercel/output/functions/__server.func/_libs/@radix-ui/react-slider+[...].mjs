...
import { i as useComposedRefs, r as createContextScope, t as createCollection } from "./react-collection+[...].mjs";
...
var Slider = /* @__PURE__ */ import_react.forwardRef(/* @__PURE__ */ __name(function Slider2(props, forwardedRef) {
	const { name, min = 0, max = 100, step = 1, orientation = "horizontal", disabled = false, minStepsBetweenThumbs = 0, preserveThumbOrder = false, defaultValue = [min], value, onValueChange = /* @__PURE__ */ __name(() => {}, "onValueChange"), onValueCommit = /* @__PURE__ */ __name(() => {}, "onValueCommit"), inverted = false, form, ...sliderProps } = props;
	...
	function updateValues(value2, atIndex, { commit } = { commit: false }) {
		...
		setValues((prevValues = []) => {
			...
			const constrainedValue = preserveThumbOrder ? clamp(nextValue, [prevValues[atIndex - 1] === void 0 ? min : prevValues[atIndex - 1] + minStepsDistance, prevValues[atIndex + 1] === void 0 ? max : prevValues[atIndex + 1] - minStepsDistance]) : nextValue;

import { M as isTruthy, N as getEnvVariable, a as createClerkRequest, b as isAutomatedEnvironment, i as constants, m as isProxyUrlRelative, o as debugRequestState, p as isHttpOrHttps, r as AuthStatus, w as isDevelopmentFromSecretKey, x as isDevelopmentEnvironment } from "../_libs/clerk__backend+clerk__shared.mjs";
import { t as errorThrower } from "./utils-BuRZoexi.mjs";
import { a as resolveKeysWithKeylessFallback, i as createNodeFileStorage, n as handleNetlifyCacheInDevInstance, r as createKeylessService, s as apiUrlFromPublishableKey, t as patchRequest } from "../_libs/clerk__shared.mjs";
import { n as commonEnvs, t as clerkClient } from "./clerkClient-C2r7-CwH.mjs";
import { n as createMiddleware, t as createCsrfMiddleware } from "./createCsrfMiddleware-B2To0gPJ.mjs";
import { t as renderErrorPage } from "./ssr.mjs";
import * as fs from "node:fs";
import * as path from "node:path";
//#region node_modules/.nitro/vite/services/ssr/assets/start-eUSMN0rH.js
